 ...
 */
#define ADELE_CORE_ABI_VERSION 2
 ...
 */
void adele_core_connect_n(Core *core,
                          const char *transport,
                          uintptr_t transport_len,
                          const char *address,
...
/*
 ...
 and is not detectable here.
 */
void adele_core_send_prompt_n(Core *core, const char *text, uintptr_t text_len);
 ...
 */
void adele_core_select_conversation_n(Core *core,
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_delete_conversation_n(Core *core,
                                      const char *conversation_id,
                                      uintptr_t conversation_id_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_archive_conversation_n(Core *core,
                                       const char *conversation_id,
                                       uintptr_t conversation_id_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_unarchive_conversation_n(Core *core,
                                         const char *conversation_id,
                                         uintptr_t conversation_id_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_set_voice_in_n(Core *core,
                               const char *conversation_id,
                               uintptr_t conversation_id_len,
                               bool enabled);
 ...
 */
void adele_core_set_adele_output_n(Core *core,
                                   const char *conversation_id,
                                   uintptr_t conversation_id_len,
                                   const char *level,
                                   uintptr_t level_len);
...
/*
 ...
 here.
 */
void adele_core_select_model_n(Core *core,
                               const char *connection_id,
...
/*
 ...
 error and is not detectable here.
 */
void adele_core_cancel_task_n(Core *core, const char *task_id, uintptr_t task_id_len);
...
/*
 ...
 error and is not detectable here.
 */
void adele_core_fetch_task_logs_n(Core *core, const char *task_id, uintptr_t task_id_len);
...
/*
 ...
 and is not detectable here.
 */
void adele_core_set_ws_jwt_n(Core *core, const char *jwt, uintptr_t jwt_len);
 ...
 */
void adele_core_set_mcp_surface_n(Core *core, const char *surface, uintptr_t surface_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_set_mcp_builtin_disabled_n(Core *core,
                                           const char *name,
                                           uintptr_t name_len,
                                           bool disabled);
...
/*
 ...
 here.
 */
void adele_core_upsert_mcp_client_server_n(Core *core,
                                           const char *server_json,
                                           uintptr_t server_json_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_remove_mcp_client_server_n(Core *core, const char *name, uintptr_t name_len);
...
/*
 ...
 is the caller's error and is not detectable here.
 */
void adele_core_set_mcp_client_server_enabled_n(Core *core,
                                                const char *name,
                                                uintptr_t name_len,
                                                bool enabled);
...
/*
 ...
 here.
 */
void adele_core_send_command_n(Core *core,
                               const char *request_id,
                               uintptr_t request_id_len,
                               const char *command_json,
                               uintptr_t command_json_len);
...
/*
 ...
 here.
 */
char *adele_core_render_markdown_n(const char *text, uintptr_t text_len);
...
/*
 ...
 here.
 */
char *adele_core_render_markdown_document_n(const char *text, uintptr_t text_len);
...
/*
 ...
 here.
 */
char *adele_core_markdown_set_content_script_n(const char *text, uintptr_t text_len);
